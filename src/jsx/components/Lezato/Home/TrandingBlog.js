    ...
    <>
      <div className="card-body">
        ...
        <div className="d-flex align-items-end mt-2 pb-4 justify-content-between">
          ...
          <span className="fs-14">
            <span className="text-black pe-2"></span>61 times
          </span>
        </div>
        <div>
          ...
          <div>
            <Link
              to={"#"}
              className=" btn btn-outline-primary btn-rounded me-2 mb-3 btn-sm"
            >
              #japanessefood
            </Link>
            <Link
              to={"#"}
              className=" btn btn-outline-primary btn-rounded mb-3  btn-sm"
            >
              #design
            </Link>
            <Link
            ...
            <Link
              to={"#"}
              className=" btn btn-outline-primary btn-rounded btn-sm mb-3"
            >
              16+
            </Link>
          </div>
