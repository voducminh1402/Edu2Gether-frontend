...
const CardBlog = [{ image: menu1 }, { image: menu2 }, { image: menu3 }];
          ...
          <div className="card-body border-bottom pt-0" key={index}>
            ...
            <div className="info">
              <h5 className="text-black mb-3">
                <Link to={"/ecom-product-grid"} className="text-black">
                  Spinach with Roasted Crab
                </Link>
              </h5>
