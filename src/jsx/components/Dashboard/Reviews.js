                    ...
                    {ReviewList.map((data, index) => (
                      ...
                      >
                        ...
                        <div className="col-xl-6 col-xxl-6">
                          ...
                          <p className="mb-0">
                            I have been there many times.Rooms ,Food and Service
                            are excellent.we did lots of Excursions and all the
                            places are from the Hotel reachable. we visited Long
                            Waterfall and was very helpful and excellent
                          </p>
                        </div>
                        <div className="col-xl-3 text-end col-xxl-2 action-btn">
                          ...
                          <Link className="review-icon rounded-circle btn-danger">
