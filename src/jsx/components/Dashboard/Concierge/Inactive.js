          ...
          >
            ...
            <tbody>
              <tr role="row" className="odd">
                ...
                <td className="job-desk">
                  <div>
                    <span className="fs-16">
                      Act as a liaison between guests and any department
                      necessary including the kitchen, housekeeping, etc
                    </span>
                  </div>
                </td>
                <td>
                ...
                <td>
                  <span className="text-danger font-w600">INACTIVE</span>
                </td>
                <td>
                  <DropdownBlog />
                </td>
              ...
              <tr role="row" className="even">
                ...
                <td className="job-desk">
                  <div>
                    <span className="fs-16">
                      Answering guest inquiries, directing phone calls,
