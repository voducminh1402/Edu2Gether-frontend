  ...
  return (
    <>
      <div className="card">
        ...
        <PerfectScrollbar
          className="card-body customer-review-bx p-0 dz-scroll loadmore-content"
              ...
              <div className="dz-info">
                <div className="dz-name mb-3">
                  <div>
                    ...
                    <span className="date text-black op8">
                ...
                <div className="dz-footer">
                  <p className="text-black op8 mb-sm-0 mb-3 me-4">
                    I have been there many times.Rooms ,Food and Service are
                    excellent.we did lots of Excursions and all the places are
                    from the Hotel reachable. we visited Long Waterfall and was
        ...
        <div className="card-footer style-1 border-0 pt-0 text-center">
          <Link
            to={"#"}
            className="dz-load-more fas fa-chevron-down"
            onClick={() => onClick()}
          >
            {" "}
