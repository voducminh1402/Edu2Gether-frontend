...
const deliveryBlog = [
  {
    image: cont11,
    title: "John Kusnaidi",
    subtitle: "Franklin Avenue St. London, ABC 12345",
  },
  {
    image: cont22,
    title: "Margaretha",
    subtitle: "Groove Street Families, DEF 244125",
  },
        ...
        <div className="card-body pb-0">
          ...
          <PerfectScrollbar className="dz-scroll">
            <div className="loadmore-content " id="DelieveryListContent">
              {data.map((data, index) => (
                <div
                  className="d-sm-flex d-block border-bottom align-items-center mb-2"
                  key={index}
                >
                  <div className="delivery-customer me-auto mb-2">
                    ...
                    <div>
                      <span className="font-w600 text-black fs-16">
                        {data.title}{" "}
                        <span className="text-primary">(4 Items)</span>
                      </span>
                  ...
                  <div className="d-flex align-items-center justify-content-end text-end location mb-2">
                    <div>
                      <span className="d-block f-s14 font-w400 text-black">
                        {data.subtitle}
                      </span>
                      <span className="text-end f-s14 font-w400 text-black">
                        United Kingdom
                      </span>
                    </div>
